...
function RecentData() {
  const { recentDaysExpenses } = useContext(Context);
  const [activeIndex, setActiveIndex] = useState(null);

  if (!recentDaysExpenses || recentDaysExpenses.length === 0) {
    return (
  ...
  const categoryTotals = recentDaysExpenses.reduce((acc, item) => {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <h2 className="text-2xl font-bold text-gray-800 mb-6">Recent Expenses Distribution</h2>
